...
public class SepetController {
	...
	public ModelAndView sepetGoster(@RequestParam(name="sonuc",required=false)String sonuc){
	...
	public String sepetGuncelle(@PathVariable int sepetAlanId,@RequestParam int adet){
